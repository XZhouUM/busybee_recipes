...
2. Ask an AI agent to format the recipe file. The agent will automatically translate the recipe to English and convert it to the correct format specified in the AGENTS.md file.
3. The pre-push hook will automatically update the index file before the changes are pushed to the repo.

Alternatively,
1. Ask an AI agent to search for a recipe on the internet and add it to the repo. The agent will automatically translate the recipe to English and convert it to the correct format specified in the AGENTS.md file.
...
You can search for recipes using an AI agent. You can also use the it to select and filter recipes based on your preferences.